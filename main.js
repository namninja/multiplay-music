...
function renderVideoResult(result) {
    console.log(result);
    return `
    <iframe class="video-thumb" allowFullScreen="allowFullScreen" src="https://www.youtube.com/embed/${result.id.videoId}?ecver=1&amp;iv_load_policy=1&amp;yt:stretch=16:9&amp;autohide=1&amp;color=red&amp;width=560&amp;width=560" width="560" height="315" allowtransparency="true" frameborder="0">
